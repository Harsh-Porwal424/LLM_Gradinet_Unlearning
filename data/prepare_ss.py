...
if TARGET_BLANK: 
    LABELS_TO_KEEP.extend(['anti-stereotype', 'unrelated'])

# Function to extract target word indices
...
# Function to extract target word from sentence
...
# Write all sentences to the files
